...
func DefaultLayout() OfficeLayout {
	...
	return OfficeLayout{
		...
		Tiles: [][]TileType{
			...
			{W, P, a, H, b, a, H, b, a, H, a, P, W, B, R, R, R, R, R, R, P, W},       // Row 6:  chairs row 2 + 3rd chair at col 9
			{W, a, b, a, b, a, a, b, a, b, a, b, a, R, R, R, R, R, R, R, R, W},       // Row 7:  open space + doorway col 12
			{W, b, a, D, C, b, D, C, a, D, C, b, W, R, R, D, C, R, D, C, R, W},       // Row 8:  desk row 3 + 3rd desk at cols 9-10
			{W, a, b, H, a, b, H, a, b, H, b, a, W, R, R, H, R, R, H, R, R, W},       // Row 9:  chairs row 3 + 3rd chair at col 9
		...
		Seats: []Seat{
			...
			{UID: "seat-13", Col: 15, Row: 9, FacingDir: DirUp, Zone: "meeting"},  // faces meeting desk at (15,8)
			{UID: "seat-14", Col: 18, Row: 9, FacingDir: DirUp, Zone: "meeting"},  // faces meeting desk at (18,8)

			// ── Meeting room: open rug seats ──
			{UID: "seat-15", Col: 15, Row: 7, FacingDir: DirDown, Zone: "meeting"}, // rug area
			{UID: "seat-16", Col: 18, Row: 7, FacingDir: DirDown, Zone: "meeting"}, // rug area
		},
	}
}
